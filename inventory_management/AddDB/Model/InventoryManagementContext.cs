    ...
    public partial class InventoryManagementContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InvoiceInputDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.ConsignmentDetail)
                    .WithMany(p => p.InvoiceInputDetails)
                    .HasForeignKey(d => d.ConsignmentDetailId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CONSIGNMENTDETAIL_ID_INVOICE_INPUTDETAILS");
            ...
            modelBuilder.Entity<InvoiceOutputDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.ConsignmentDetail)
                    ...
                    .HasForeignKey(d => d.ConsignmentDetailId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CONSIGNMENTDETAIL_ID_INVOICE_OUTPUTDETAILS");
